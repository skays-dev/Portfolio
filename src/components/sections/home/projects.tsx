                                ...
                                <div className="card-body rounded-3xl primary-secondary-gradient w-full p-[1px] shadow-card">
                                    <div className="item p-6 rounded-3xl">
                                        ...
                                        <div className="flex justify-between">
                                            <Link href='https://www.google.com' target="_blank" className="btn flex items-center text-center py-2 px-6 rounded-full">Read More</Link>
                                            <Link href='https://www.google.com' target="_blank" className="btn-secondary text-center py-4 px-6 rounded-full">
                                                <div className="flex items-center gap-3">
                                                    <Image src='http://localhost:3000/assets/imgs/template/icons/github.png' alt="logo github" width={32} height={32} /> check On Github
                                                </div>
                                            </Link>
                                        </div>
                                    </div>
